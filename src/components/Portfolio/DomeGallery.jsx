...
/**
 * Default images removed — you will pass images from your Portfolio page:
 * <DomeGallery images={[{src, alt}, ...]} />
 */
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="absolute left-0 right-0 h-[120px] z-[5] pointer-events-none"
            style={{
              bottom: "-1px",
              background: `
                linear-gradient(
